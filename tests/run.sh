...
for file in wp-mobile-de-sync.php includes/*.php includes/tabs/*.php includes/integrations/*.php templates/*.php templates/parts/*.php tests/*.php tests/integration/*.php bin/*.php; do
